...
const OS: React.FC = () => {
    ...
    }, [notes, nextZIndex, windows.length]); // This effect depends on `windows` implicitly, but adding it creates a loop. This is a controlled dependency.
    ...
    const updateWindowPosition = useCallback((id: string, position: { x: number; y: number }) => {
        // In Mac mode, the top menu bar is 24px high. Prevent windows from being dragged above it.

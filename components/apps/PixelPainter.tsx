...
export const PixelPainter: React.FC<AppProps> = ({ isActive, instanceId, documentIdToOpen }) => {
    ...
    useEffect(() => {
        ...
        const eventHandlers: { [key: string]: () => void } = {
            'pixelpainter:file:new': handleNew,
            'pixelpainter:file:open': handleOpen,
            'pixelpainter:file:save': handleSave,
            'pixelpainter:file:saveas': handleSaveAs,
            'pixelpainter:edit:undo': handleUndo,
            ...Object.fromEntries((['pencil', 'eraser', 'fill', 'rectangle', 'oval', 'line'] as PixelPainterTool[]).map(t => [`pixelpainter:tools:${t}`, () => setTool(t)])),
        };
    ...
    }, [isActive, instanceId, handleNew, handleOpen, handleSave, handleSaveAs, handleUndo, setTool]);

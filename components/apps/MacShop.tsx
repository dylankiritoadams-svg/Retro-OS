...
interface ToolButtonProps {
    toolName: MacShopTool;
    onSelect: (tool: MacShopTool) => void;
    currentTool: MacShopTool;
    children: React.ReactNode;
}

const ToolButton: React.FC<ToolButtonProps> = ({ toolName, onSelect, currentTool, children }) => (

            ...
            {Array.from({ length: 7 }).map((_, i) => {
                ...
                return (
                    ...
                    >
                        ...
                        {tasks.filter(task => task.startTime && isSameDay(parseISO(task.startTime), currentDay)).map(task => {
    ...
    const renderDailyView = () => (
         <div className="flex-grow grid grid-cols-[auto,1fr]">
            ...
            <div className="border-r border-gray-300 relative">
                ...
                {tasks.filter(task => task.startTime && isSameDay(parseISO(task.startTime), day)).map(task => {
                    const taskDate = parseISO(task.startTime!);

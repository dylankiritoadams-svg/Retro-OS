...
import { DeepSearch } from './components/apps/DeepSearch';
...
const DeepSearchIcon: React.FC<IconProps> = ({ className = "h-10 w-10" }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} viewBox="0 0 32 32" shapeRendering="crispEdges" fill="currentColor">
        <path d="M5 5h22v22H5z m1 1v20h20V6z m2 2h16v1H8z m0 3h16v1H8z m0 3h10v1H8z m12 0h4v1h-4z"/>
    </svg>
);
...
export const APPS: AppDefinition[] = [
    ...
    { id: 'planner', name: 'Weekly Planner', icon: <PlannerIcon />, component: WeeklyPlanner, defaultSize: { width: 900, height: 400 } },
    ...
    { id: 'assistant', name: 'Assistant Ive', icon: <AssistantIveIcon />, component: AssistantIve, defaultSize: { width: 600, height: 450 } },
    { id: 'browser', name: 'Web Browser', icon: <BrowserIcon />, component: WebBrowser, defaultSize: { width: 800, height: 600 } },
    ...
    { id: 'deepsearch', name: 'DeepSearch', icon: <DeepSearchIcon />, component: DeepSearch, defaultSize: { width: 600, height: 400 } },
